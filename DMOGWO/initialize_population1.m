function pop = initialize_population1(num_tasks, pop_size, start_point, task_coords,task)
    % num_tasks: 任务点数量 (20)
    ...
    population = zeros(2.*pop_size, num_tasks + 2);
    ...
    %     population(i, :) = [task_sequence, breakpoints];
    % end
    pop = selecttaskpoint(population,task);
