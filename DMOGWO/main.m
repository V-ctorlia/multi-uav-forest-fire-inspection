...
for i = 1:levels
   ...
   %% 运行 DMOGWO 算法 (这里假设结果为解集 population) 


   disp('Running MOGWO optimization...');
   [ Archive,Archive_costs]=MOGWO(popSize, numGenerations, numPoints, numDrones, target, startPoint, task);
